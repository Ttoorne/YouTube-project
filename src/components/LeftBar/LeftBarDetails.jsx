...
const LeftBarDetails = () => {
  ...
  return (
    <div
      className={`left-bar__details_position ${
        showLeftBarDetails ? "" : "close"
      }`}
    >
      <div className="left-bar__details">
        <div className="left-bar__middle_details">
