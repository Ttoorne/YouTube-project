  ...
  return (
    <div className="navbar__container">
      ...
      <div className="navbar__right">
        {user ? (
          <div
            className="navbar__right_create"
            onClick={() => navigate("/add")}
          >
            <div
              style={{ fill: pathName === "/add" ? "#ff4e45" : "#f1f1f1" }}
              className="navbar__right_create-svg"
            >
              <svg
                height="24"
                style={{
        ...
        <div className="navbar__right_user">
          <Box sx={{ flexGrow: 0 }}>
            <Tooltip title="Аккаунт">
              <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }}>
                <Avatar alt="" src={userAvatar} id="navbar__user_avatar" />
              </IconButton>
            </Tooltip>
            <Menu
              sx={{ mt: "45px" }}
